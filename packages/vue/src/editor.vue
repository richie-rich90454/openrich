...
watch(() => props.editable, (val) => editorRef.value?.setEditable(val));
watch(() => props.theme, (val) => editorRef.value?.setTheme(val));
watch(() => props.locale, (val) => { if (val) editorRef.value?.setLocale(val); });
</script>
